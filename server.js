...
app.use("/api/v1/clients/invoices",
  publimiter,
  authenticateToken,
  authAccess,
  authIP, 
...
app.use("/api/v1/clients/invoices/credits",
  publimiter,
  authenticateToken,
  authAccess,
  authIP, 
...
app.use("/api/v1/clients/invoices/deposits",
  publimiter,
  authenticateToken,
  authAccess,
  authIP,
...
app.use("/api/v1/clients/contracts",
  publimiter,
  authenticateToken,
  authAccess,
  authIP, 
...
app.use("/api/v1/clients/contracts/prices",
  publimiter,
  authenticateToken,
  authAccess,
  authIP,
...
app.use("/api/v1/clients/jobs/proofs",
  publimiter,
  authenticateToken,
  authAccess,
  authIP,
...
app.use("/api/v1/clients/jobs/downloads",
  publimiter,
  authenticateToken,
  authAccess,
  authIP,
...
app.use("/api/v1/clients/jobs/contacts",
  publimiter,
  authenticateToken,
  authAccess,
  authIP,
...
app.use("/api/v1/clients/jobs/orbipays",
  publimiter,
  authenticateToken,
  authAccess,
  authIP,
...
app.use("/api/v1/clients/jobs/orders",
  publimiter,
  authenticateToken,
  authAccess,
  authIP,
...
app.use("/api/v1/clients/jobs/facilities",
  publimiter,
  authenticateToken,
  authAccess,
  authIP,
